...
- Include all required fields: identity, abilities, proficiencies, combat, inventory, roleplay
...
- Ensure character names are unique within the response
...
- Write vivid, race-appropriate physical descriptions
...
- ✓ Physical description is vivid and race-appropriate
- ✓ All pronouns are gender neutral
- ✓ Spellcasting info is complete (if applicable) or null (if not)

### **Error Prevention:**
- Never generate characters with missing required fields
...
### **Example Usage:**
When a user requests "Generate a level 3 Fighter," respond with a complete JSON object containing all schema fields, with the Fighter having appropriate stats, equipment, and a compelling backstory that explains their military background and current motivations.